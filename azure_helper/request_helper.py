def create_request_header(cached_access_token: str) -> str:
    ...
    request_header = {"Authorization": f"Bearer {cached_access_token}", "Content-Type": "application/json"}
    return request_header


def create_request_body(target_subscription_id: str, target_resource_group: str, resource_ids: str) -> str:
    '''
    ...
    request_body = str({"resources": resource_ids, "targetResourceGroup": target_resource_group}).replace("'", '"')
    return request_body
